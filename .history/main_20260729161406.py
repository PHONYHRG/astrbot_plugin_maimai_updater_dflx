...
PLAIN_COMMANDS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("luoxuebind", ("luoxuebind", "落雪绑定", "绑定落雪")),
    ("luoxueupdate", ("luoxueupdate", "落雪更新", "更新落雪")),
    ("multi", ("multi", "导")),
)
...
class MaimaiUpdaterPlugin(Star):
    ...
    @command("maimaistatus", alias={"绑定状态"})
    ...
    # ====== 落雪命令（修改）======
    @command("luoxuebind", alias={"落雪绑定", "绑定落雪"})
    ...
    @command("luoxueupdate", alias={"落雪更新", "更新落雪"})
